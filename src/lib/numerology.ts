...
export const monthContent: Record<number, MonthContent> = {
  1: {
    title: "חודש של התחלות והחלטות חדשות",
    brings: "הזמן לפעול ולהתחיל תהליכים שדחית. האנרגיה תומכת ביוזמה, בפתיחת דלתות חדשות ובקבלת החלטות שמניעות אותך קדימה.",
  },
  2: {
    title: "חודש של סבלנות ושיתוף פעולה",
    brings: "הזמן להקשיב, לשתף פעולה ולתת לתהליכים לזרום בקצבם. חודש של עיבוד רגשי, חיבורים עמוקים וסבלנות לדרך.",
  },
  3: {
    title: "חודש של ביטוי עצמי ושמחה",
    brings: "הזמן לדבר, ליצור ולשתף. האנרגיה קלה ומאירה - חודש שמזמין אותך לבטא את עצמך ולהנות מהדרך.",
  },
  4: {
    title: "חודש של עבודה, סדר ותכנון",
    brings: "הזמן למיקוד ועבודה מסודרת. מה שתעשי בהתמדה עכשיו יניב תוצאות אמיתיות. חודש לבנות, לארגן ולהתקדם צעד אחד בכל פעם.",
  },
  5: {
    title: "חודש של שינויים וגמישות",
    brings: "הזמן לזרום עם שינויים. הזדמנויות מגיעות ממקומות לא צפויים - חשוב להיות פתוחה וגמישה במקום לאחוז בנוקשות.",
  },
  6: {
    title: "חודש של אהבה, בית ואחריות",
    brings: "הזמן לחזק קשרים ולטפל בעצמך ובסביבה. חודש שמחזיר אותך אל הלב - לאהבה, לבית ולמה שבאמת חשוב.",
  },
  7: {
    title: "חודש של האטה, עומק וחיבור פנימי",
    brings: "הזמן לנוח, לחשוב עמוק ולשמוע את הקול הפנימי. חודש שמזמין האטה ופנייה פנימה - לא לדחוף קדימה, אלא לתת לתובנות לעלות.",
  },
  8: {
    title: "חודש של כוח, שפע והצלחה",
    brings: "הזמן לקדם מטרות ולממש פוטנציאל. האנרגיה תומכת בהחלטות מקצועיות, כלכליות ובכל מקום שדורש כוח ונחישות.",
  },
  9: {
    title: "חודש של שחרור וסגירת מעגלים",
    brings: "הזמן לסגור דלתות ולפנות מקום לחדש. מה שכבר לא משרת אותך - תני לו ללכת. הסיום של החודש הזה פותח משהו חדש.",
  },
};
